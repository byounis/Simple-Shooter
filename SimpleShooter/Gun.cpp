...
void AGun::PullTrigger()
{
	...
	if (bSuccess)
	{
		...
		if (!TryGetOwnerController(Controller))
		{
			return;
		}
...
bool AGun::GunTrace(FHitResult& Hit, FVector& ShotDirection) const
{
	...
	return GetWorld()->LineTraceSingleByChannel(Hit, Location, End, ECC_GameTraceChannel1, CollisionQueryParams);
}

bool AGun::TryGetOwnerController(AController*& Controller) const
{
